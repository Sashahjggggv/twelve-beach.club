...
>
	...
	<div id="content-head">
		...
		<p>Згенеровано <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO</a>, це XML-карта сайту, призначена для використання пошуковими системами, як Google, Bing або Яндекс.</p>
		<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 10.10.2023 at 01:34			</p>
		</xsl:if>
	</div>
</xsl:template>
